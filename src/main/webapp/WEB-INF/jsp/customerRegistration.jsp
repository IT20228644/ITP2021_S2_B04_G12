                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="col-6 col-sm-6 col-md-8 col-lg-8 col-xl-8">
                            <a href="/reservation">
                                ...
                                font-size: 14px;font-weight: 700;letter-spacing: 0;padding: 12px 15px;text-transform: uppercase;"
                            ...
                            <a href="/counterReservation">
                                <button style="background: #CF5300 none repeat scroll 0 0;border-color:#Be5504;color: #fff;
                                font-size: 14px;font-weight: 700;letter-spacing: 0;padding: 9px 16px;text-transform: uppercase;" type="button" class="btnq2 btn"><i
                                        class="">
                                    Reservation</i>
                                </button>
                            </a>
