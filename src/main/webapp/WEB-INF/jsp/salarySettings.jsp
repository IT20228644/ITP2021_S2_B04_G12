                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                        <form method="POST" action="saveSettings" name="saveSettings">
                            ...
                            <div class="form-group">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><br>
                                    ...
                                    <input type="number" class="form-control"
                                           required="required" name="epf" id="epf"
                                           placeholder="EPF"/></div>

                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"><br>
                                    <label>ETF</label>
                                    <input type="number" class="form-control"
                                           required="required" name="etf"
                                           id="etf" placeholder="ETF"/></div>
                            ...
                            <button type='submit' class="btn btn-dark" style="width: 15%; top: 20px; position: relative"
                                    value="Register">
                                Save
                            </button>
