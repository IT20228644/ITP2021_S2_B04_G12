    ...
    <div class="main_container">
        ...
        <div class="right_col" role="main">
                    ...
                    <div class="col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4">
                        <a href="inventory">
                            <button style=" border: 3px solid #4c2a18;background-color: #8c6f60;
                                    color: #ffffff;font-weight: bolder" type="button"  class="btnq2 btn"><i class="fa fa-reply">
                                Back</i>
                            </button>
                        </a>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                    ...
                    <button type='reset' class="btn btn-dark" style="top: 20px; position: relative" value="">Reset</button>
