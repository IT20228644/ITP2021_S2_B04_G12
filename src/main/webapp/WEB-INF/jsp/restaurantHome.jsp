...
<div class="navbar navbar-expand-lg bg-light navbar-light">
    <div class="container-fluid">
        <a href="index.html" class="navbar-brand">Sapphire <span>Marriote</span></a>
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            <div class="navbar-nav ml-auto">
                ...
                <ul id="top_nav">
                    ...
                    <li class="end"><a href="onlineCustomernew"><i class="fa fa-user" style="color: rgba(255,255,255,0.91); font-size:20px;">
                        LogIn ${loggerId.name}
        ...
        <div class="owl-carousel testimonials-carousel">
            <div class="testimonial-item">
                <div class="testimonial-img">
                    <img src="../../online/img/testimonial-1.jpg" alt="Image">
                </div>
                <p>
            ...
            <div class="testimonial-item">
                <div class="testimonial-img">
                    <img src="../../online/img/testimonial-2.jpg" alt="Image">
                </div>
                <p>
                    Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                </p>
            ...
            <div class="testimonial-item">
                <div class="testimonial-img">
                    <img src="../../online/img/testimonial-3.jpg" alt="Image">
                </div>
                <p>
                    Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                </p>
            ...
            <div class="testimonial-item">
                <div class="testimonial-img">
                    <img src="../../online/img/testimonial-4.jpg" alt="Image">
                </div>
                <p>
                    Lorem ipsum dolor sit amet elit. Phasel nec preti mi. Curabit facilis ornare velit non vulput
                </p>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="../../online/img/blog-1.jpg" alt="Blog">
                    </div>
            ...
            <div class="col-md-6">
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="../../online/img/blog-2.jpg" alt="Blog">
                    </div>
                    <div class="blog-content">
                        <h2 class="blog-title">Lorem ipsum dolor sit amet</h2>
                        <div class="blog-meta">
