...
<div class="menu">
                        ...
                        <div class="col-lg-7 col-md-12">
                            <table id="dataTablesButton1">
                                ...
                                <c:forEach items="${loadAllFoods}" var="e">
                                    <c:if test="${e.menutype == 'breakfast' }">
                                    <tr class="menu-item">
                                        <td>
                                            <div class="menu-img">
                                                <img src="${e.mpicture}" alt="Image">
                                            </div>
                                        </td>
                                        <td class="menu-text" >
  ...
  position: absolute;white-space:nowrap;top:40px;left:100px;">
                                        ...
                                        <td class="menu-text" >
                                            <h3><strong style="padding-left:340px;">${e.unitPrice}</strong></h3>
                                        </td>
                                        <td style="display: none" >${e.menusId}</td>
                                        <td style="display: none" >${e.unitPrice}</td>
...
<%--                                            <td style="display: none" >${e.unitPrice}</td>--%>
  ...
  position: absolute;white-space:nowrap;top:40px;left:100px;">
                                        ...
                                        <%--                                                <td class="menu-text" >--%>
                                                <%--                                                    <h3><strong style="padding-left:340px;">${e.unitePrice}</strong></h3>--%>
                                                <%--                                                </td>--%>
