                ...
                <div class="page-title">
                    <div class="title_left">
                        ...
                        <a style=" float: left" href="allAttendance">
                                <button style=" border: 2px solid #775e51;  background-color: #8c6f60;  width: 100%;
                                color: #E9EDEF;font-weight: bolder" type='submit' class="btn btn-secondary" value="Register">
