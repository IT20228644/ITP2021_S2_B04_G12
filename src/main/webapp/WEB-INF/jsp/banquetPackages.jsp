                            ...
                            <div class="x_content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <!-- price element -->
                                        <div class="col-md-3 col-sm-6  " style="color: #604c0f">
                                            <div class="pricing">
                                                <div class="title">
                                                    <h1>${menu1.name}</h1>
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <div class="pricing_footer" style="background-color:#604c0f;
                                        ...
                                        <div class="col-md-3 col-sm-6  " style="color: #604c0f">
                                            <div class="pricing">
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <div class="pricing_footer" style="background-color:#604c0f;
                                    color: #fafafa;font-weight: bolder">
                                        ...
                                        <!-- price element -->
                                        <div class="col-md-3 col-sm-6  " style="color: #794e4e">
                                            <div class="pricing">
                                                <div class="title">
                                                    <h1>${menu3.name}</h1>
