...
public class BanquetAddDTO {
    ...
    public BanquetAddDTO(int orderId, String name, String contactNo, java.util.Date date,
                         String hallId, int noOfPlates, double advancePayment, String orderState) {
        this.orderId = orderId;
        this.name = name;
        this.contactNo = contactNo;
        this.date = (Date) date;
    ...
    public BanquetAddDTO(int orderId, String name, String address, String contactNo,
                         Date date, String hallId, int noOfPlates, double advancePayment,
                         double foodPrice, double otherPrices, int billId, String orderState, double total) {
        this.orderId = orderId;
        this.name = name;
        this.address = address;
        this.contactNo =contactNo;
